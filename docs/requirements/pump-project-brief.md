...
| **RBAC** | **Page** permissions (**`comms-log`**, **`comms-templates`**) + **`CommRbacContext`** derived in app from those page grants; Edge is security backstop |
